...
export const DESTINATIONS = {
  ...
  activities: {
    ...
    items: [
      { slug: 'kazbegi-gergeti', name: 'Kazbegi & Gergeti', category: 'Scenic tour', price: '120 GEL', priceSuffix: 'per guest', rating: '4.9', reviews: '86 reviews', tags: ['1 day', 'Easy', 'Transfer'], image: '/assets/activities/kobi-mountain-chapel.jpg', facts: [['Duration', '8 hours'], ['Group', 'Up to 7'], ['Languages', 'EN · RU'], ['Season', 'All year']], included: ['Local guide', 'Return transfer', 'Photo stops', 'Water'], description: 'A full-day road trip through the dramatic Terek valley to Stepantsminda and the iconic Gergeti Trinity Church.' },
      { slug: 'snowmobile-plateau', name: 'Snowmobile plateau ride', category: 'Winter adventure', price: '200 GEL', priceSuffix: 'per ride', rating: '4.8', reviews: '52 reviews', tags: ['2 hours', 'Equipment', 'Guide'], image: '/assets/activities/gudauri-panorama-riders.jpg', facts: [['Duration', '2 hours'], ['Level', 'Beginner'], ['Guests', '1–2'], ['Season', 'Winter']], included: ['Safety briefing', 'Helmet', 'Fuel', 'Local guide'], description: 'Ride across open snowfields above Gudauri with a guide and panoramic stops along the way.' },
      { slug: 'paragliding-gudauri', name: 'Paragliding over Gudauri', category: 'Air adventure', price: '350 GEL', priceSuffix: 'per guest', rating: '4.9', reviews: '114 reviews', tags: ['Tandem', '15–25 min', 'Video'], image: '/assets/activities/freeride-ridge.jpg', facts: [['Flight', '15–25 min'], ['Format', 'Tandem'], ['Pilot', 'Certified'], ['Video', 'Included']], included: ['Certified pilot', 'Equipment', 'GoPro video', 'Slope transfer'], description: 'A tandem flight above the Caucasus with a certified pilot and a video of your experience.' },
      { slug: 'heli-ski', name: 'Heli-ski drop', category: 'Advanced', price: '900 GEL', priceSuffix: 'per guest', rating: '5.0', reviews: '31 reviews', tags: ['Advanced', 'Full day', 'Safety kit'], image: '/assets/activities/powder-turn.png', facts: [['Duration', 'Full day'], ['Level', 'Advanced'], ['Group', 'Up to 4'], ['Runs', '3–5']], included: ['Mountain guide', 'Helicopter drops', 'Avalanche kit', 'Lunch'], description: 'Remote Caucasus lines, small groups and a certified mountain guide for experienced freeride guests.' },
      { slug: 'freeride-day', name: 'Freeride discovery day', category: 'Ski & snowboard', price: '280 GEL', priceSuffix: 'per guest', rating: '4.9', reviews: '67 reviews', tags: ['6 hours', 'Intermediate+', 'Guide'], image: '/assets/activities/freeride-team-ridge.jpg', facts: [['Duration', '6 hours'], ['Level', 'Intermediate+'], ['Group', 'Up to 5'], ['Terrain', 'Off-piste']], included: ['Certified guide', 'Route planning', 'Safety briefing', 'Radio'], description: 'Learn to read the terrain and discover the best snow for the day with a local freeride guide.' },
      { slug: 'gastro-route', name: 'Khinkali & mountain wine route', category: 'Food & culture', price: '110 GEL', priceSuffix: 'per guest', rating: '4.8', reviews: '43 reviews', tags: ['Half day', 'Tastings', 'Transfer'], image: '/assets/activities/narovani-valley-road.jpg', facts: [['Duration', '5 hours'], ['Group', 'Up to 8'], ['Meals', 'Included'], ['Season', 'All year']], included: ['Local host', 'Three tastings', 'Return transfer', 'Soft drinks'], description: 'A relaxed route through family kitchens and cellars with regional dishes and Georgian wine.' }
    ]
  },
  rental: {
    slug: 'rental',
