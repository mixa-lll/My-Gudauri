...
export async function getAdminInstructor(db, slug) {
  ...
  if (!base) return null;
  const [disciplines, languages, about, tags, media, reviews] = await db.batch([
