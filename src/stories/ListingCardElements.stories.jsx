import { ListingCardAction, ListingCardPrice, ListingCardRating } from '../design-system';
...
export const Rating = { parameters: { composition: defineComposition({ root: 'Rating' }) }, render: () => <div className="sb-canvas sb-row"><ListingCardRating rating="4.9" reviews="38 reviews" /><ListingCardRating rating="5.0" reviews="8+ years" /></div> };
