...
const SECTION_NAV_LABELS = { routeProgram: 'Program', activitySchedule: 'Schedule', routeMap: 'Route', includedServices: 'Included', equipmentList: 'Equipment', safetyRequirements: 'Safety', transferVehicle: 'Vehicle', transferRoute: 'Route', transferConditions: 'Conditions' };
const SECTION_ANCHORS = { routeProgram: 'route', activitySchedule: 'schedule', routeMap: 'route-map', includedServices: 'included', equipmentList: 'equipment', safetyRequirements: 'safety', transferVehicle: 'vehicle', transferRoute: 'route', transferConditions: 'conditions' };
...
export const PATTERN_CONTRACTS = {
  ...
  transferObject: { task: 'Confirm one Vehicle × Route offer, its fixed price and trip conditions before requesting a transfer.', sequence: ['ObjectStickyNav', 'ObjectMainTags', 'ObjectDescription', 'TransferVehicleDetails', 'TransferRouteDetails', 'IncludedServices?', 'TransferConditions', 'Vehicle ObjectReviews?', 'BookingConfigurator', 'Full-width BookingSteps', 'Full-width FaqAccordion', 'TransferRelatedOffers'], states: ['loading', 'ready', 'unavailable'], interaction: 'The bidirectional route is preserved in the URL, route overview and booking draft; the compact configurator collects offer-shaping answers while exact addresses remain in the full request.', mobile: 'Vehicle media and route endpoints stack without overflow; the configurator becomes a disclosure with touch-sized controls.', accessibility: 'Sequential headings, localized route labels, a text direction control, labelled form controls, visible focus and review context that names the completed route.' }
};
