...
export default { title: 'Blocks/Detail/Booking Steps', component: DetailBookingSteps, tags: ['autodocs'], parameters: { composition: defineComposition({ root: 'DetailBookingSteps' }) } };
