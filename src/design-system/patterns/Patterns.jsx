...
export const PATTERN_CONTRACTS = {
  ...
  transferObject: { task: 'Confirm the route, vehicle facts and fixed-price inclusions before requesting a transfer.', sequence: ['ObjectStickyNav', 'ObjectMainTags', 'ObjectDescription', 'RouteMap', 'IncludedServices?', 'ObjectReviews?', 'BookingConfigurator', 'Full-width BookingSteps', 'Full-width FaqAccordion', 'ObjectRelatedListings'], states: ['loading', 'ready', 'unavailable'], interaction: 'The catalog direction is preserved in the detail URL, route overview and booking draft; passenger count and pickup are collected before the full request.', mobile: 'Route endpoints stack without horizontal overflow and the booking configurator becomes a disclosure with touch-sized controls.', accessibility: 'Sequential headings, localized route labels, labelled form controls, visible focus and a direction expressed as text rather than color alone.' }
};
