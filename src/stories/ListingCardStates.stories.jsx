...
export const MissingMedia = { render: () => <div className="sb-canvas sb-card-preview"><ListingCard to="/missing" title="Offer without published photography" placeholderLabel="Photography coming soon" placeholderKind="activity" description="A category-specific branded placeholder preserves the same card geometry." footer={<ListingCardAction />} /></div> };
