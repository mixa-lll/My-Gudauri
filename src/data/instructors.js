...
export const INSTRUCTORS = [
  ['mikhail', 'Mikhail Andreev', 'Ski & snowboard · 8 years experience', 4.8, 6, '/assets/design-2/card-mikhail.png', ['snowboard', 'ski'], ['Ge', 'En', 'Ru']],
  ['oleg', 'Oleg Yung', 'Snowboard · Freeride specialist', 4.8, 6, '/assets/design-2/card-oleg.png', ['snowboard'], ['Ge', 'En']],
  ['alex-red', 'Alex Red', 'Ski · Beginner-friendly lessons', 4.8, 6, '/assets/design-2/card-red-ski.png', ['ski'], ['Ge', 'En']],
  ['andrey', 'Andrey Gregorev', 'Ski & snowboard · Kids and families', 4.8, 6, '/assets/design-2/card-andrey.png', ['snowboard', 'ski'], ['Ge', 'En']],
  ['nino', 'Nino Beridze', 'Ski · Technique and confidence', 4.9, 11, '/assets/design-2/card-mikhail.png', ['ski'], ['Ge', 'En', 'Ru']],
  ['giorgi', 'Giorgi Maisuradze', 'Snowboard · All levels welcome', 4.8, 8, '/assets/design-2/card-oleg.png', ['snowboard'], ['Ge', 'En']],
  ['levan', 'Levan Kapanadze', 'Ski & snowboard · Private lessons', 4.9, 14, '/assets/design-2/card-red-ski.png', ['ski', 'snowboard'], ['Ge', 'En']],
  ['mari', 'Mari Gelashvili', 'Ski · First-time and family lessons', 5, 9, '/assets/design-2/card-andrey.png', ['ski'], ['Ge', 'En', 'Ru']]
].map(([slug, name, description, rating, reviews, image, sports, languages]) => ({
  id: slug,
  slug,
  name,
  description,
...
export const INSTRUCTOR_DETAILS = Object.fromEntries(INSTRUCTORS.map((instructor, index) => [instructor.slug, {
  ...
  tags: ['Beginners', 'Intermediate', 'Private lessons', 'Confidence training'],
  media: DEFAULT_MEDIA,
