import { ReviewCard, ReviewsSection } from '../../design-system';
...
export default { title: 'Blocks/Detail/Reviews Section', component: ReviewsSection, tags: ['autodocs'], parameters: { composition: defineComposition({ root: 'ReviewsSection' }) } };
