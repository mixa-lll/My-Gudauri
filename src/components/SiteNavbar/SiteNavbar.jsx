          ...
          isMenuMounted && (
            ...
            >
              ...
              >
                ...
                <LanguageSwitcher className="site-nav-menu__language" variant="stacked" />
                      ...
                      <motion.div key={category.slug} {...itemMotion(index)}>
                        <Link className="site-nav__category" to={category.href} onClick={() => closeMenu()}>
                          ...
                          <span className="site-nav__category-copy">
                            <span className="site-nav__category-title">{t(`categories.${category.slug}.title`)}</span>
                            <span className="site-nav__category-desc">{t(`categories.${category.slug}.description`)}</span>
                          </span>
