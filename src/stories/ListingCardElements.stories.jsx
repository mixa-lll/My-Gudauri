...
export const RatingEmphasis = { parameters: { composition: defineComposition({ root: 'Rating' }) }, render: () => <div className="sb-canvas sb-row"><ListingCardRating rating="4.8" size="md" tone="accent" variant="plaque" /><ListingCardRating rating="4.8" reviews="6 reviews" size="md" tone="accent" variant="plaque" /><ListingCardRating rating="4.8" reviews="6 reviews" size="lg" tone="accent" /></div> };
