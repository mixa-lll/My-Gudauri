...
export default { title: 'Blocks/Detail/Description Section', component: DescriptionSection, tags: ['autodocs'], parameters: { composition: defineComposition({ root: 'DescriptionSection' }) } };
