import { CertificationsSection, EquipmentList, IncludedServices, RouteProgram, SafetyRequirements } from '../../design-system';
import { defineComposition } from '../../design-system/architecture/registry';

export default { title: 'Blocks/Detail/Specific Sections', tags: ['autodocs'], parameters: { controls: { disable: true } } };
export const Certifications = { parameters: { composition: defineComposition({ root: 'CertificationsSection' }) }, render: () => <CertificationsSection items={['APSI Level D', 'First aid']} /> };
