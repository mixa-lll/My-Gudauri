...
export const TransferFromGudauri = story('TransferCard', () => <div className="sb-canvas sb-card-preview"><TransferCard item={{ ...destinationItem('transfers'), route: 'Gudauri → Tbilisi Airport', direction: 'from-gudauri' }} /></div>);
...
export const CategoryFallbacks = story('ActivityCard', () => <div className="sb-canvas sb-grid sb-grid--cards"><ActivityCard item={{ ...destinationItem('activities'), image: undefined }} /><InstructorCard item={{ ...INSTRUCTORS[0], image: undefined }} /><RentalCard item={{ ...destinationItem('rental'), image: undefined }} /><TransferCard item={{ ...destinationItem('transfers'), image: undefined }} /><StayCard item={{ ...destinationItem('stays'), image: undefined }} /></div>);
