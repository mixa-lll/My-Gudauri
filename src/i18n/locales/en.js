...
export const en = {
  ...
  booking: {
    ...
    transfer: {
      ...
      to: 'To',
      swap: 'Swap direction',
      samePrice: 'The price is the same in both directions and from the airport or the city.',
      directionLabel: 'Route',
      pickupLabel: 'Pickup',
      dropoffLabel: 'Drop-off',
      pickupQuestion: 'Where should we pick you up in {{city}}?',
      dropoffQuestion: 'Where are we taking you in {{city}}?',
      cityAddress: 'Address in {{city}}',
      meetingNotes: 'Where should the driver wait?',
      gudauriPickup: 'Pickup address in Gudauri',
      gudauriDropoff: 'Drop-off address in Gudauri',
      gudauriHint: 'Hotel, apartment or complex name is enough.',
      flightArrival: 'Arrival flight number',
      flightDeparture: 'Departure flight number',
      flightHint: 'We track the flight and adjust the pickup if it is delayed.',
      flightLabel: 'Flight',
      date: 'Pickup date',
      time: 'Pickup time',
      arrivalDate: 'Arrival date',
      arrivalTime: 'Landing time',
      timeHint: 'You can confirm the exact time with the manager later.',
      timeHintFlight: 'Take it from your ticket — we add the waiting time ourselves.',
      whenLabel: 'When',
      groupLabel: 'Group',
      extrasLabel: 'Extras',
      extrasDescription: 'All extras are free — tell us in advance and the driver will have them ready.',
      free: 'Free',
      addExtra: 'Add',
      extraAdded: 'Added',
      commentPlaceholder: 'Child ages, extra luggage or anything else the driver should know.'
    },
    validation: {
      transferPoint: 'Choose where the driver should meet you.',
      transferCityAddress: 'Add the address for the driver.',
      transferMeeting: 'Describe the meeting point.',
      transferGudauriAddress: 'Add the address in Gudauri.',
      transferTrip: 'Choose the date and the number of passengers.',
    ...
    steps: {
      ...
      transferRoute: {
        label: 'Route and pickup',
        title: 'Your route and pickup point',
        description: 'Check the direction and tell us where the driver should meet you.'
      },
      transferTrip: {
        label: 'Trip details',
        title: 'Trip details',
        description: 'When you travel, how many of you there are and anything to prepare.'
      },
    ...
    flows: {
      ...
      'transfer-request-v2': {
        ...
        fields: {
          ...
          pointLabel: { label: 'Meeting point' },
          passengers: { label: 'Passengers', singularLabel: 'Passenger', shortLabel: 'ppl', shortSingularLabel: 'person' },
          suitcases: { label: 'Suitcases', singularLabel: 'Suitcase' },
          skis: { label: 'Skis or snowboards', singularLabel: 'Ski or snowboard' },
          flightNumber: { label: 'Flight number', placeholder: 'For example A9 641' },
          cityAddress: { label: 'Address', placeholder: 'Hotel, apartment or street address' },
          meetingNotes: { label: 'Where should the driver wait?', placeholder: 'Describe the meeting point' },
          gudauriAddress: { label: 'Address in Gudauri', placeholder: 'Hotel or apartment name' },
          date: { label: 'Date' },
          time: { label: 'Time' }
        }
      },
