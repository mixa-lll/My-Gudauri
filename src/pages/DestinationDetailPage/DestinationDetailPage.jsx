...
import { BackLink, Container, FaqAccordion, MediaPlaceholder, ObjectHero, PrimaryFacts, SectionHeading, SiteFooter, SiteNavbar } from '../../design-system';
      ...
      <main>
        <Container width="detail">
          <ObjectHero
            ...
            media={(
              <div className="destination-gallery" role="group" aria-label={`${item.name} gallery`}>
          ...
          <div className="destination-detail__layout">
            <div className="destination-detail__content">
              <PrimaryFacts items={item.facts.map(([label, value]) => ({ label, value }))} />
