...
export default { title: 'Blocks/Detail/Related Listings', component: RelatedListings, tags: ['autodocs'], parameters: { composition: defineComposition({ root: 'RelatedListings' }) } };
