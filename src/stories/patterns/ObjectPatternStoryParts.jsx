...
export function objectPatternProps(category) {
  ...
  const basePrice = category === 'rental' ? 70 : category === 'stay' ? 240 : 120;
  const offer = createBookingOffer({ definition, object: { id: `${category}:storybook`, slug: 'storybook-offer', name: 'Storybook offer' }, basePrice, availability: 'Available this week' });
  return {
